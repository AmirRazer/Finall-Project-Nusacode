...
<head>
    ...
    <!--Favicon-->
    <link rel="shortcut icon" href="/theme-frontend/images/favicon.ico" type="image/x-icon">
    <link rel="icon" href="/theme-frontend/images/favicon.ico" type="image/x-icon">
    <link rel="apple-touch-icon" sizes="180x180" href="/theme-frontend/images/apple-touch-icon.png">

    <!-- THEME CSS
	================================================== -->
    <!-- Bootstrap -->
    <link rel="stylesheet" href="/theme-frontend/plugins/bootstrap/css/bootstrap.min.css">
    <!-- FontAwesome -->
    <link rel="stylesheet" href="/theme-frontend/plugins/font-awesome/css/font-awesome.min.css">
    <!-- Slick Carousel -->
    <link rel="stylesheet" href="/theme-frontend/plugins/slick-carousel/slick.css">
    <link rel="stylesheet" href="/theme-frontend/plugins/slick-carousel/slick-theme.css">
    <!-- manin stylesheet -->
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xs-12 col-sm-3 col-md-3">
                    ...
                    <div class="logo">
                        <a href="index.html">
                            <img src="/theme-frontend/images/logos/logo.png" alt=""> <!-- Replace Logo Here -->
                        </a>
                    </div>
                    <!-- End Logo -->
                </div>
                <div class="col-xs-12 col-sm-9 col-md-9">
                    <div class="top-ad-banner float-right">
                        <a href="#">
                            <img src="/theme-frontend/images/news/ad-pro.png" class="img-fluid" alt="banner-ads">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg site-main-nav navigation">
                        <a class="navbar-brand d-lg-none" href="index.html">
                            <img src="/theme-frontend/images/logos/footer-logo.png" alt="">
                        </a>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 col-sm-12 col-lg-6 text-center">
                    <a href="index.html"><img src="/theme-frontend/images/logos/footer-logo.png" alt="" class="img-fluid"></a>
...
================================================== -->
    ...
    <script src="/theme-frontend/plugins/jquery/jquery.js"></script>
    <!-- Bootstrap jQuery -->
    <script src="/theme-frontend/plugins/bootstrap/js/bootstrap.min.js"></script>
    <!-- Slick Slider -->
    <script src="/theme-frontend/plugins/slick-carousel/slick.min.js"></script>
    <!-- Google Map -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCC72vZw-6tGqFyRhhg5CkF2fqfILn2Tsw"></script>
    <script src="/theme-frontend/plugins/google-map/gmap.js"></script>
    <!-- main js -->
    <script src="/theme-frontend/js/custom.js"></script>
